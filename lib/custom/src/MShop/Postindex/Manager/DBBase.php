	...
	implements \Aimeos\MShop\Common\Manager\Iface, \Aimeos\MShop\Common\Manager\Find\Iface
{
	...
	public function __construct( \Aimeos\MShop\Context\Item\Iface $context )
	{
		...
		$this->manager = \Aimeos\MShop::create( $this->getContext(), 'post' );
	}
	 ...
	 * @return \Aimeos\MShop\Post\Item\Iface New product item object
	 */
	 ...
	 */
	public function find( string $code, array $ref = [], string $domain = 'post', string $type = null,
	 ...
	 * @param string[] $ref List of domains to fetch list items and referenced items for
	 * @param bool $default Add default criteria
	 * @return \Aimeos\MShop\Post\Item\Iface Post item object
	 */
	 ...
	 *
	 * @return \Aimeos\MShop\Post\Manager\Iface Post manager object
	 */
	 ...
	 * @return \Aimeos\MShop\Post\Item\Iface[] List of post items
	 */
		...
		array $ref, int &$total = null, string $cfgPathSearch, string $cfgPathCount ) : \Aimeos\Map
	{
		...
		$postSearch = $manager->filter();
		$postSearch->setConditions( $postSearch->compare( '==', 'post.id', $ids ) );
		$postSearch->slice( 0, $search->getLimit() );
		$items = $manager->search( $postSearch, $ref );
