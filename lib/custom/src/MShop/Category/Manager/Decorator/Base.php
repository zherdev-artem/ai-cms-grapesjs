...
namespace Aimeos\MShop\Category\Manager\Decorator;


/**
 * Provides common methods for category manager decorators.
 *
 * @package MShop
 * @subpackage Category
 */
	...
	extends \Aimeos\MShop\Common\Manager\Decorator\Base
{
	 ...
	 * @return \Aimeos\Map Associative list of items implementing \Aimeos\MShop\Category\Item\Iface with IDs as keys
	 */
	 ...
	 */
	public function insert( \Aimeos\MShop\Category\Item\Iface $item, string $parentId = null, string $refId = null ) : \Aimeos\MShop\Category\Item\Iface
	{
	 ...
	 */
	public function move( string $id, string $oldParentId, string $newParentId, string $refId = null ) : \Aimeos\MShop\Category\Manager\Iface
	{
