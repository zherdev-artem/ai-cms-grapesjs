	...
	extends \Aimeos\MShop\PostIndex\Manager\Text\Standard
{
	private $searchConfig = array(
		'index.text:relevance' => array(
			...
			'internalcode' => ':site AND mpostindte."langid" = $1 AND CAST( to_tsvector(mpostindte."content") @@ to_tsquery( $2 ) AS integer )',
		...
		'sort:index.text:relevance' => array(
			...
			'internalcode' => 'ts_rank(to_tsvector(mpostindte."content"), to_tsquery( $2 ))',
