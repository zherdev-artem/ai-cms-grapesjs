	...
	implements \Aimeos\MShop\PostIndex\Manager\Text\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private $searchConfig = array(
		...
		'index.text.id' => array(
			'code' => 'index.text.id',
			'internalcode' => 'mpostindte."post"',
			'internaldeps' => array( 'LEFT JOIN "mshop_post_index_text" AS mpostindte ON mpostindte."postid" = mpost."id"' ),
			'label' => 'Post index text ID',
			'type' => 'string',
		...
		'index.text:url' => array(
			'code' => 'index.text:url()',
			'internalcode' => ':site AND mpostindte."url"',
			'label' => 'Post URL',
			'type' => 'string',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
			'public' => false,
		...
		'index.text:name' => array(
			...
			'internalcode' => ':site AND mpostindte."langid" = $1 AND mpostindte."name"',
			'label' => 'Post name, parameter(<language ID>)',
			'type' => 'string',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
			'public' => false,
		),
		...
		'index.text:relevance' => array(
			...
			'internalcode' => ':site AND mpostindte."langid" = $1 AND POSITION( $2 IN mpostindte."content" )',
			'label' => 'Post texts, parameter(<language ID>,<search term>)',
			'type' => 'float',
		...
		'sort:index.text:relevance' => array(
			...
			'internalcode' => '-POSITION( $2 IN mpostindte."content" )',
			'label' => 'Post texts, parameter(<language ID>,<search term>)',
			'type' => 'float',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_FLOAT,
			'public' => false,
	...
	/**
	 * Counts the number post that are available for the values of the given key.
	 *
	 * @param \Aimeos\MW\Criteria\Iface $search Search criteria
	 * @param string $key Search key (usually the ID) to aggregate post for
	 * @param string|null $value Search key for aggregating the value column
	 * @param string|null $type Type of the aggregation, empty string for count or "sum" or "avg" (average)
	 * @return \Aimeos\Map List of ID values as key and the number of counted post as value
	 */
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/post/index/manager/text/delete' );
	}
	...
	public function cleanup( string $timestamp ) : \Aimeos\MShop\PostIndex\Manager\Iface
	{
		 ...
		 *
		 * @see mshop/post/index/manager/text/cleanup/ansi
		 */

		/** mshop/post/index/manager/text/cleanup/ansi
		 * Deletes the index text records that haven't been touched
		 *
		 * During the rebuild process of the product index, the entries of all
		 * active post will be removed and readded. Thus, no stale data for
		 * these post will remain in the database.
		 *
		 * All post that have been disabled since the last rebuild will be
		 * still part of the index. The cleanup statement removes all records
		 * that belong to post that haven't been touched during the index
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/post/index/manager/text/count/ansi
		 * @see mshop/post/index/manager/text/delete/ansi
		 * @see mshop/post/index/manager/text/insert/ansi
		 * @see mshop/post/index/manager/text/search/ansi
		 * @see mshop/post/index/manager/text/text/ansi
		 */
		return $this->cleanupBase( $timestamp, 'mshop/post/index/manager/text/cleanup' );
	}
	...
	{
		/** mshop/post/index/manager/text/delete/mysql
		 * Deletes the items matched by the given IDs from the database
		 *
		 * @see mshop/post/index/manager/text/delete/ansi
		 */

		/** mshop/post/index/manager/text/delete/ansi
		 * Deletes the items matched by the given IDs from the database
		 *
		 ...
		 * @see mshop/post/index/manager/text/text/ansi
		 */
		return $this->deleteItemsBase( $itemIds, 'mshop/post/index/manager/text/delete', true, 'postid' );
	}
	...
	{
		$path = 'mshop/post/index/manager/text/submanagers';
		return $this->getResourceTypeBase( 'post/index/text', $path, [], $withsub );
	}
	...
	public function getSearchAttributes( bool $withsub = true ) : array
	{
		...
		/** mshop/post/index/manager/text/submanagers
	...
	{
		/** mshop/post/index/manager/text/name
		 ...
		 *
		 *  mshop/post/index/manager/text/name = Mytext
		 *
		...
		/** mshop/post/index/manager/text/decorators/excludes
		 ...
		 *
		 *  mshop/post/index/manager/text/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see mshop/post/index/manager/text/decorators/global
		 * @see mshop/post/index/manager/text/decorators/local
		 */

		/** mshop/post/index/manager/text/decorators/global
		 ...
		 * manager.
		 *
		 *  mshop/post/index/manager/text/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see mshop/common/manager/decorators/default
		 * @see mshop/post/index/manager/text/decorators/excludes
		 * @see mshop/post/index/manager/text/decorators/local
		 */

		/** mshop/post/index/manager/text/decorators/local
		...
		return $this->getSubManagerBase( 'postindex', 'text/' . $manager, $name );
	}
	...
	public function optimize() : \Aimeos\MShop\PostIndex\Manager\Iface
	{
		 ...
		 *
		 * @see mshop/post/index/manager/text/optimize/ansi
		 */

		/** mshop/post/index/manager/text/optimize/ansi
		 * Optimizes the stored text data for retrieving the records faster
		 *
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see mshop/post/index/manager/text/aggregate/ansi
		 * @see mshop/post/index/manager/text/cleanup/ansi
		 * @see mshop/post/index/manager/text/count/ansi
		 * @see mshop/post/index/manager/text/insert/ansi
		 * @see mshop/post/index/manager/text/search/ansi
		 * @see mshop/post/index/manager/text/text/ansi
		 */
		return $this->optimizeBase( 'mshop/post/index/manager/text/optimize' );
	}


	/**
	 * Rebuilds the index text for searching post or specified list of post.
	 * This can be a long lasting operation.
	 *
	...
	public function rebuild( iterable $items = [] ) : \Aimeos\MShop\PostIndex\Manager\Iface
	{
		...
		try
		{
			/** mshop/post/index/manager/text/insert/mysql
			 * Inserts a new text record into the product index database
			 *
			 * @see mshop/post/index/manager/text/insert/ansi
			 */

			/** mshop/post/index/manager/text/insert/ansi
			 * Inserts a new text record into the product index database
			 *
			 ...
			 * @see mshop/post/index/manager/text/text/ansi
			 */
			$stmt = $this->getCachedStatement( $conn, 'mshop/post/index/manager/text/insert' );
	...
	{
		/** mshop/post/index/manager/text/search/mysql
		 * Retrieves the records matched by the given criteria in the database
		 *
		 * @see mshop/post/index/manager/text/search/ansi
		 */

		/** mshop/post/index/manager/text/search/ansi
		 * Retrieves the records matched by the given criteria in the database
		 *
		 ...
		 * @see mshop/post/index/manager/text/text/ansi
		 */
		$cfgPathSearch = 'mshop/post/index/manager/text/search';

		/** mshop/post/index/manager/text/count/mysql
		 * Counts the number of records matched by the given criteria in the database
		 *
		 * @see mshop/post/index/manager/text/count/ansi
		 */

		/** mshop/post/index/manager/text/count/ansi
		 * Counts the number of records matched by the given criteria in the database
		 *
		 ...
		 * @see mshop/post/index/manager/text/text/ansi
		 */
		$cfgPathCount = 'mshop/post/index/manager/text/count';
	...
	/**
	 * Saves the text items referenced indirectly by post
	 *
	 * @param \Aimeos\MW\DB\Statement\Iface $stmt Prepared SQL statement with place holders
	 * @param \Aimeos\MShop\Post\Item\Iface $item Post item containing associated text items
	 */
	protected function saveTexts( \Aimeos\MW\DB\Statement\Iface $stmt, \Aimeos\MShop\Post\Item\Iface $item )
	{
		$texts = [];
        ...
        foreach( $item->getRefItems( 'text' ) as $text ) {
            $texts[$text->getLanguageId()]['content'][] = strip_tags($text->getContent());
        }
	 ...
	 */
	protected function saveTextMap( \Aimeos\MW\DB\Statement\Iface $stmt, \Aimeos\MShop\Post\Item\Iface $item, array $texts )
	{
	 ...
	 * @param string $url Post name in URL
	...
	protected function getSubManagers() : array
	{
		if( $this->subManagers === null )
		{
			 ...
			 */
			foreach( $config->get( 'mshop/post/index/manager/text/submanagers', [] ) as $domain )
			{
				$name = $config->get( 'mshop/post/index/manager/text/' . $domain . '/name' );
