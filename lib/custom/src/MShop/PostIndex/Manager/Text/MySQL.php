	...
	extends \Aimeos\MShop\PostIndex\Manager\Text\Standard
{
	private $searchConfig = array(
		'index.text:relevance' => array(
			...
			'internalcode' => ':site AND mpostindte."langid" = $1 AND MATCH( mpostindte."content" ) AGAINST( $2 IN BOOLEAN MODE )',
		...
		'sort:index.text:relevance' => array(
			...
			'internalcode' => 'MATCH( mpostindte."content" ) AGAINST( $2 IN BOOLEAN MODE )',
