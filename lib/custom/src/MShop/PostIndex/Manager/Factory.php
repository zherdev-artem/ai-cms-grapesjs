	...
	implements \Aimeos\MShop\Common\Factory\Iface
{
	...
	public static function create( \Aimeos\MShop\Context\Item\Iface $context, string $name = null ) : \Aimeos\MShop\Common\Manager\Iface
	{
		 ...
		 *
		 *  mshop/post/index/manager/name = Mymanager
		 *
		...
		/** mshop/post/index/manager/decorators/excludes
		 ...
		 *
		 *  mshop/post/index/manager/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see mshop/post/index/manager/decorators/global
		 * @see mshop/post/index/manager/decorators/local
		 */

		/** mshop/post/index/manager/decorators/global
		 ...
		 *
		 *  mshop/post/index/manager/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see mshop/common/manager/decorators/default
		 * @see mshop/post/index/manager/decorators/excludes
		 * @see mshop/post/index/manager/decorators/local
		 */

		/** mshop/post/index/manager/decorators/local
		 ...
		 * @see mshop/post/index/manager/decorators/global
		 */
		return self::addManagerDecorators( $context, $manager, 'postindex' );
	}
}
