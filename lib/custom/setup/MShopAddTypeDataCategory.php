 ...
 */
class MShopAddTypeDataCategory extends \Aimeos\MW\Setup\Task\MShopAddTypeData
{
	/**
	...
	{
		return ['TablesCreateCategory', 'MShopSetLocale', 'MShopAddTypeData'];
	}
