 ...
 */
class MShopAddTypeDataPost extends \Aimeos\MW\Setup\Task\MShopAddTypeData
{
	/**
	...
	{
		return ['TablesCreatePost', 'MShopSetLocale', 'MShopAddTypeData'];
	}
	...
	public function migrate()
	{
		...
		$filename = __DIR__ . $ds . 'default' . $ds . 'data' . $ds . 'post-type.php';
