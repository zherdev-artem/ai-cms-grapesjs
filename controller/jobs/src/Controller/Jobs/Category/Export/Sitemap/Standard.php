...
namespace Aimeos\Controller\Jobs\Category\Export\Sitemap;


/**
 * Job controller for category sitemap.
 *
 * @package Controller
 * @subpackage Jobs
 */
	...
	implements \Aimeos\Controller\Jobs\Iface
{
	...
	{
		return $this->getContext()->getI18n()->dt( 'controller/jobs', 'Category site map' );
	}
	...
	{
		return $this->getContext()->getI18n()->dt( 'controller/jobs', 'Creates a category site map for search engines' );
	}
	...
	/**
	 * Adds the given categorys to the content object for the site map file
	 *
	 * @param \Aimeos\MW\Container\Content\Iface $content File content object
	 * @param \Aimeos\Map $items List of category items implementing \Aimeos\MShop\Category\Item\Iface
	 */
	protected function addItems( \Aimeos\MW\Container\Content\Iface $content, \Aimeos\Map $items )
	{
		$config = $this->getContext()->getConfig();

		/** controller/jobs/category/export/sitemap/changefreq
		 * Change frequency of the category
		 *
		 * Depending on how often the category content changes
		 ...
		 * @category User
		 * @category Developer
		 * @see controller/jobs/category/export/sitemap/container/options
		 * @see controller/jobs/category/export/sitemap/location
		 * @see controller/jobs/category/export/sitemap/max-items
		 * @see controller/jobs/category/export/sitemap/max-query
		 */
		$changefreq = $config->get( 'controller/jobs/category/export/sitemap/changefreq', 'daily' );

		/** controller/jobs/category/export/sitemap/template-items
		 * Relative path to the XML items template of the category site map job controller.
		 *
		 ...
		 * @since 2019.02
		 * @category Developer
		 * @see controller/jobs/category/export/sitemap/template-header
		 * @see controller/jobs/category/export/sitemap/template-footer
		 * @see controller/jobs/category/export/sitemap/template-index
		 */
		$tplconf = 'controller/jobs/category/export/sitemap/template-items';
		$default = 'category/export/sitemap-items-body-standard';
	...
	protected function createContainer() : \Aimeos\MW\Container\Iface
	{
		...
		/** controller/jobs/category/export/sitemap/location
		 ...
		 * categorys. Please make sure that the protocol and domain
		 ...
		 * @see controller/jobs/category/export/sitemap/max-items
		 * @see controller/jobs/category/export/sitemap/max-query
		 * @see controller/jobs/category/export/sitemap/changefreq
		 */
		$location = $config->get( 'controller/jobs/category/export/sitemap/location' );

		/** controller/jobs/category/export/sitemap/container/options
		...
		$options = $config->get( 'controller/jobs/category/export/sitemap/container/options', $default );

		if( $location == null )
		{
			$msg = sprintf( 'Required configuration for "%1$s" is missing', 'controller/jobs/category/export/sitemap/location' );
	...
	{
		/** controller/jobs/category/export/sitemap/template-header
		 * Relative path to the XML site map header template of the category site map job controller.
		 *
		 * The template file contains the XML code and processing instructions
		 ...
		 * @since 2019.02
		 * @category Developer
		 * @see controller/jobs/category/export/sitemap/template-items
		 * @see controller/jobs/category/export/sitemap/template-footer
		 * @see controller/jobs/category/export/sitemap/template-index
		 */
		$tplconf = 'controller/jobs/category/export/sitemap/template-header';
		$default = 'category/export/sitemap-items-header-standard';
	...
	{
		/** controller/jobs/category/export/sitemap/template-footer
		 * Relative path to the XML site map footer template of the category site map job controller.
		 *
		 * The template file contains the XML code and processing instructions
		 ...
		 * @see controller/jobs/category/export/sitemap/template-index
		 */
		$tplconf = 'controller/jobs/category/export/sitemap/template-footer';
		$default = 'category/export/sitemap-items-footer-standard';
	...
	protected function createSitemapIndex( \Aimeos\MW\Container\Iface $container, array $files )
	{
		...
		/** controller/jobs/category/export/sitemap/template-index
		 * Relative path to the XML site map index template of the category site map job controller.
		 *
		 * The template file contains the XML code and processing instructions
		 ...
		 * @see controller/jobs/category/export/sitemap/template-footer
		 */
		$tplconf = 'controller/jobs/category/export/sitemap/template-index';
		$default = 'category/export/sitemap-index-standard';

		/** controller/jobs/category/export/sitemap/baseurl
		 ...
		 * added to the robots.txt in the document root of your domain:
		 *
		 * Sitemap: https://www.yourshop.com/your/sitemap/path/aimeos-category-sitemap-index.xml
		 *
		 * More details about site maps can be found at
		 * {@link http://www.sitemaps.org/protocol.html sitemaps.org}
		 *
		 ...
		 * @see controller/jobs/category/export/sitemap/location
		 */
		$baseUrl = $config->get( 'controller/jobs/category/export/sitemap/baseurl' );

		if( $baseUrl == null )
		{
			$msg = sprintf( 'Required configuration for "%1$s" is missing', 'controller/jobs/category/export/sitemap/baseurl' );
			throw new \Aimeos\Controller\Jobs\Exception( $msg );
		}
		...
		$content = $container->create( 'aimeos-category-sitemap-index.xml' );
	...
	/**
	 * Exports the categorys into the given container
	 *
	 * @param \Aimeos\MW\Container\Iface $container Container object
	 * @param bool $default True to filter exported categorys by default criteria
	...
	{
		$config = $this->getContext()->getConfig();
		/** controller/jobs/category/export/sitemap/domains
		 * List of associated items from other domains that should be fetched for the sitemap
		 *
		 * Categorys consist not only of the base data but also of texts, media and
		 * other details. Those information is associated to the category via their lists.
		 ...
		 * @see controller/jobs/category/export/sitemap/changefreq
		 */
		$domains = $config->get( 'controller/jobs/category/export/sitemap/domains', ['text'] );

		/** controller/jobs/category/export/sitemap/max-items
		 * Maximum number of categories per site map
		 *
		 * Each site map file must not contain more than 50,000 links and it's
		 * size must be less than 10MB. If your category URLs are rather long
		 ...
		 * @see controller/jobs/category/export/sitemap/max-query
		 * @see controller/jobs/category/export/sitemap/changefreq
		 * @see controller/jobs/category/export/sitemap/domains
		 */
		$maxItems = $config->get( 'controller/jobs/category/export/sitemap/max-items', 50000 );

		/** controller/jobs/category/export/sitemap/max-query
		 * Maximum number of categories per query
		 *
		 * The categorys are fetched from the database in bunches for efficient
		 ...
		 * {@see controller/jobs/category/export/sitemap/max-items max-items}
		 *
		 ...
		 * @see controller/jobs/category/export/sitemap/domains
		 */
		$maxQuery = $config->get( 'controller/jobs/category/export/sitemap/max-query', 1000 );
		...
		$search->setSortations( array( $search->sort( '+', 'category.id' ) ) );
	...
	{
		return sprintf( 'aimeos-category-sitemap-%d.xml', $number );
	}
}
