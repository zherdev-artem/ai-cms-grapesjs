...
$treeTarget = $this->config( 'client/html/category/tree/url/target' );
$treeCntl = $this->config( 'client/html/category/tree/url/controller', 'category' );
$treeAction = $this->config( 'client/html/category/tree/url/action', 'list' );
$treeConfig = $this->config( 'client/html/category/tree/url/config', [] );
