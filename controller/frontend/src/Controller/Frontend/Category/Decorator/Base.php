...
namespace Aimeos\Controller\Frontend\Category\Decorator;


/**
 * Base for category frontend controller decorators
 *
 * @package Controller
 * @subpackage Frontend
 */
abstract class Base
	...
	implements \Aimeos\Controller\Frontend\Common\Decorator\Iface, \Aimeos\Controller\Frontend\Category\Iface
{
	...
	public function __construct( \Aimeos\Controller\Frontend\Iface $controller, \Aimeos\MShop\Context\Item\Iface $context )
	{
		...
		$iface = \Aimeos\Controller\Frontend\Category\Iface::class;
	 ...
	 * @since 2019.04
	 */
	public function compare( string $operator, string $key, $value ) : \Aimeos\Controller\Frontend\Category\Iface
	{
	 ...
	 * @since 2019.04
	 */
	public function getTree( int $level = \Aimeos\Controller\Frontend\Category\Iface::TREE ) : \Aimeos\MShop\Category\Item\Iface
	{
	 ...
	 * @since 2019.04
	 */
	public function parse( array $conditions ) : \Aimeos\Controller\Frontend\Category\Iface
	{
	 ...
	 * @since 2019.04
	 */
	public function root( string $id = null ) : \Aimeos\Controller\Frontend\Category\Iface
	{
	 ...
	 * @return \Aimeos\Map Ordered list of items implementing \Aimeos\MShop\Category\Item\Iface
	 * @since 2019.10
	 */
	 ...
	 * @since 2019.10
	 */
	public function slice( int $start, int $limit ) : \Aimeos\Controller\Frontend\Category\Iface
	{
	 ...
	 * @since 2019.10
	 */
	public function sort( ?string $key = null ) : \Aimeos\Controller\Frontend\Category\Iface
	{
	 ...
	 * @since 2019.04
	 */
	public function uses( array $domains ) : \Aimeos\Controller\Frontend\Category\Iface
	{
	 ...
	 * @return \Aimeos\Controller\Frontend\Category\Iface Category controller for fluent interface
	 */
	public function visible( array $catIds ) : \Aimeos\Controller\Frontend\Category\Iface
	{
