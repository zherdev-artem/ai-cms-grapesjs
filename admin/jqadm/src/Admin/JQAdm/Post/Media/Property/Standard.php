...
namespace Aimeos\Admin\JQAdm\Post\Media\Property;
...
{
	/** admin/jqadm/post/media/property/name
	 * Name of the property subpart used by the JQAdm post media implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Post\Media\Property\Myname".
	...
	{
		/** admin/jqadm/post/media/property/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/post/media/property/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/post/media/property/decorators/global
		 * @see admin/jqadm/post/media/property/decorators/local
		 */

		/** admin/jqadm/post/media/property/decorators/global
		 ...
		 *
		 *  admin/jqadm/post/media/property/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/post/media/property/decorators/excludes
		 * @see admin/jqadm/post/media/property/decorators/local
		 */

		/** admin/jqadm/post/media/property/decorators/local
		 ...
		 *
		 *  admin/jqadm/post/media/property/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/post/media/property/decorators/global
		 */
		return $this->createSubClient( 'post/media/property/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/post/media/property/subparts
		 * List of JQAdm sub-clients rendered within the post media property section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/post/media/property/subparts', [] );
	}
	 ...
	 */
	protected function toArray( \Aimeos\MShop\Post\Item\Iface $item, array $data, bool $copy = false ) : array
	{
		$idx = 0;
		$siteId = $this->getContext()->getLocale()->getSiteId();
	...
	{
		/** admin/jqadm/post/media/property/template-item
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/post/media/property/template-item';
		$default = 'post/item-media-property-standard';
