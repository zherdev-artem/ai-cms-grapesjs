...
/**
 * Factory for post lists type JQAdm client
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/**
	 * Creates a post lists type client object
	 *
	...
	{
		/** admin/jqadm/type/post/lists/name
		 ...
		 *
		 *  \Aimeos\Admin\JQAdm\Post\Lists\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Admin\JQAdm\Post\Lists\Myfavorite
		 *
		 * then you have to set the this configuration option:
		 *
		 *  admin/jqadm/type/post/lists/name = Myfavorite
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'admin/jqadm/type/post/lists/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Admin\\JQAdm\\Iface';
		$classname = '\\Aimeos\\Admin\\JQAdm\\Type\\Post\\Lists\\' . $name;
		...
		return self::addClientDecorators( $context, $client, 'type/post/lists' );
	}
