...
/**
 * Factory for category lists type JQAdm client
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/**
	 * Creates a category lists type client object
	 *
	...
	{
		/** admin/jqadm/type/category/lists/name
		 ...
		 *
		 *  \Aimeos\Admin\JQAdm\Category\Lists\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Admin\JQAdm\Category\Lists\Myfavorite
		 *
		 * then you have to set the this configuration option:
		 *
		 *  admin/jqadm/type/category/lists/name = Myfavorite
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'admin/jqadm/type/category/lists/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Admin\\JQAdm\\Iface';
		$classname = '\\Aimeos\\Admin\\JQAdm\\Type\\Category\\Lists\\' . $name;
		...
		return self::addClientDecorators( $context, $client, 'type/category/lists' );
	}
