...
namespace Aimeos\Admin\JQAdm\Category\Media\Property;
...
{
	/** admin/jqadm/category/media/property/name
	 * Name of the property subpart used by the JQAdm category media implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Category\Media\Property\Myname".
	...
	{
		/** admin/jqadm/category/media/property/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/category/media/property/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/category/media/property/decorators/global
		 * @see admin/jqadm/category/media/property/decorators/local
		 */

		/** admin/jqadm/category/media/property/decorators/global
		 ...
		 *
		 *  admin/jqadm/category/media/property/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/category/media/property/decorators/excludes
		 * @see admin/jqadm/category/media/property/decorators/local
		 */

		/** admin/jqadm/category/media/property/decorators/local
		 ...
		 *
		 *  admin/jqadm/category/media/property/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/category/media/property/decorators/global
		 */
		return $this->createSubClient( 'category/media/property/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/category/media/property/subparts
		 * List of JQAdm sub-clients rendered within the category media property section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/category/media/property/subparts', [] );
	}
	 ...
	 */
	protected function toArray( \Aimeos\MShop\Category\Item\Iface $item, array $data, bool $copy = false ) : array
	{
		$idx = 0;
		$siteId = $this->getContext()->getLocale()->getSiteId();
	...
	{
		/** admin/jqadm/category/media/property/template-item
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/category/media/property/template-item';
		$default = 'category/item-media-property-standard';
