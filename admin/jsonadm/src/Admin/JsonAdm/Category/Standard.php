...
namespace Aimeos\Admin\JsonAdm\Category;
...
{
	/** admin/jsonadm/category/decorators/excludes
	 ...
	 * @see admin/jsonadm/category/decorators/global
	 * @see admin/jsonadm/category/decorators/local
	 */

	/** admin/jsonadm/category/decorators/global
	 ...
	 * client.
	 *
	 *  admin/jsonadm/category/decorators/global = array( 'decorator1' )
	 *
	 * This would add the decorator named "decorator1" defined by
	 * "\Aimeos\Admin\Jsonadm\Common\Decorator\Decorator1" only to the
	 * "category" Jsonadm client.
	 *
	 * @param array List of decorator names
	 * @since 2016.01
	 * @category Developer
	 * @see admin/jsonadm/common/decorators/default
	 * @see admin/jsonadm/category/decorators/excludes
	 * @see admin/jsonadm/category/decorators/local
	 */

	/** admin/jsonadm/category/decorators/local
	 ...
	 * ("\Aimeos\Admin\Jsonadm\Category\Decorator\*") around the Jsonadm
	 * client.
	 *
	 *  admin/jsonadm/category/decorators/local = array( 'decorator2' )
	 *
	 * This would add the decorator named "decorator2" defined by
	 * "\Aimeos\Admin\Jsonadm\Category\Decorator\Decorator2" only to the
	 * "category" Jsonadm client.
	 *
	 * @param array List of decorator names
	 * @since 2016.01
	...
	{
		/** admin/jsonadm/partials/category/template-data
		 * Relative path to the data partial template file for the category client
		 *
		 ...
		 * @category Developer
		 */
		$this->getView()->assign( array( 'partial-data' => 'admin/jsonadm/partials/category/template-data' ) );
